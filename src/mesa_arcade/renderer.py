...
class Renderer(arcade.View):
    ...
    def setup_figures(self):
        ...
        if len(self.figures) == 1:
            ...
            fig_1_x = self.window_width / 2 - fig_width / 2 - fig_width / 4 - self.atomic_height * 3
            ...
            if len(self.figures) == 4:
                ...
                fig_4.setup(x=fig_4_x, y=fig_4_y, width=fig_width, height=fig_height, renderer=self)
    ...
    def add_fps_display(self):
        ...
        self.anchor.add(
            ...
            anchor_y="top",
            align_x=int(self.atomic_width * 32),
            align_y=int(-self.atomic_height * 3 - self.atomic_height * 0.25,),
            )
